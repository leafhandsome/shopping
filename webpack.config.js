...
module.exports = {
    ...
    module: {
        loaders: [{
            ...
            {
                test: /\.less$/,
                loader: ExtractTextPlugin.extract({ fallback: ['style-loader', 'css-loader', 'less-loader'], use: 'less-loader' })

            },
            {
                // 在使用npm安装的 node-sass的时候会自动跑到github上去下载，会很慢，这时请使用 cnpm i node-sass sass-loader --save-dev
                test: /\.scss$/,
                loader: ExtractTextPlugin.extract({ fallback: ['style-loader', 'css-loader', 'sass-loader'], use: 'scss-loader' })
