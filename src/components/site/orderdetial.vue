                    ...
                    <div class="comp">
                        <div class="tmpl routeanimate">
                            ...
                            <div class="section clearfix">
                                ...
                                <div class="right-auto"  v-if="orderD.orderinfo">
                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <router-link class="btn-pay" v-if="orderD.orderinfo.status<=1" v-bind="{to:'/site/shoppingmall/'+orderD.orderinfo.id}">去付款</router-link>
